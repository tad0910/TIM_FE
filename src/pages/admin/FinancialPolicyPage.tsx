...
const GOOGLE_DOC_URL = 'https://drive.google.com/file/d/1JprCEqC7fwYxyG892xGTvvy75rj6fAC1/preview?tab=t.0';
const GOOGLE_DOC_DOWNLOAD_URL = 'https://drive.google.com/uc?export=download&id=1JprCEqC7fwYxyG892xGTvvy75rj6fAC1';
                    ...
                    <div className="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                        <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between bg-white">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h1 className="text-xl font-bold text-gray-900">Chính sách tài chính</h1>
                                    <p className="text-sm text-gray-500 mt-0.5">
                                        Quy định và hướng dẫn về học phí
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="w-full" style={{ height: 'calc(100vh - 200px)', minHeight: '600px' }}>
                            {GOOGLE_DOC_URL ? (
                                <iframe
                                    src={`${GOOGLE_DOC_URL}&embedded=true`}
