...
export default function FormDropout({
  onSubmit,
  onCancel,
  student,
  enrollment,
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="text-center">
        ...
        <p className="mt-2 text-sm italic text-green-600">
          (Đơn thôi học sẽ được các trưởng bộ phận xem xét và thông báo đến học
      ...
      <div className="flex justify-center gap-3 pt-6">
        ...
        <button
          type="submit"
          disabled={!formData.classId || !!enrollmentError || isSubmitting}
